<%-- 
    Document   : RegistroVehiculoA
    Created on : 30/06/2022, 02:11:20 PM
    Author     : User
--%>
...
<html>
    ...
    <center>
        ...
        <h1 class="RegistrarVehiculo">Registrar Vehiculo</h1>
        <form method="post" action="Vehiculo" class="registro">
            ...
            <button class="btn1">Registrar Vehiculo</button>
            <input type="hidden" value="1" name="opcion">
            <button class="btn2"><a  href="menu.jsp" >Volver Atras</a></button>
